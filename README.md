...
В корне репозитория размещен файл .gitlab-ci.yml  который отслеживает изменеия в директориях backend/forntend. При наличии изменений запускается роцесс CI/CD состоящий из этапов:
